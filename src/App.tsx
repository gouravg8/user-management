	...
	return (
		<div className="flex flex-col gap-8 bg-slate-800 justify-start py-16 h-screen">
			...
			<h1
				...
				className="flex gap-1 items-center md:cursor-pointer font-semibold text-white border w-fit mx-auto border-orange-800 bg-orange-600 px-4 py-2 rounded-full mt-6 z-20"
			>
				<IoReload />
				User management
			</h1>
